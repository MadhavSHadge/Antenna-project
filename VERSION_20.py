...
class MotorControlGUI(QMainWindow):
    ...
    def submit_parameters(self):
        ...
        pulses_per_rotation = self.pulses_entry.text()  # Read pulses per rotation from the entry field
        self.motor_control.send_command(f"A{angle}")
        self.motor_control.set_pulses_per_rotation(int(pulses_per_rotation))  # Example: Convert to int if needed
        ...
        self.motor_control.write_log(f"Angle set: {angle}, Pulses per rotation set: {pulses_per_rotation}")
