...
class ArduinoMotorControl(QMainWindow):
    ...
    def initUI(self):
        ...
        main_layout.addWidget(motor_controls_group, 0, 0, 2, 1)
        ...
        main_layout.addWidget(self.submit_button, 4, 0, 1, 2)

        # Reset Button
        self.reset_button = QPushButton('Reset')
        self.reset_button.clicked.connect(self.reset_all)
        main_layout.addWidget(self.reset_button, 5, 0, 1, 2)
    ...
    def submit_parameters(self):
        ...
        pulses = self.pulse_entry.text()
        pwm_value = self.calculated_speed_display.text()
        self.send_command(f'S{pulses},{pwm_value}')
        self.write_motor_settings()
        QMessageBox.information(self, "Parameters Submitted", "All parameters have been submitted to the Arduino.")
